  ...
  return (
    <div className="relative group">
      <button
        ...
        className="inline-flex cursor-pointer items-center gap-2 rounded-full bg-secondary/50 px-4 py-1.5 text-sm text-foreground transition-[background-color,transform] duration-150 ease-out hover:bg-accent active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
        {copied ? (
