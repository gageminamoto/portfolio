...
export function AsciiTrainFooter() {
  ...
  return (
    <footer className="relative mt-8 left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen border-t border-border">
      <div className="mx-auto max-w-xl px-6 pt-6 pb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <EmailPill />
